<%@ Page Title="" Language="C#" MasterPageFile="~/inicio.Master" AutoEventWireup="true" CodeBehind="choferes.aspx.cs" Inherits="WebCapa.choferes" %>
              ...
              <div class="card-body">
                <div class="table-responsi
                    ...
                    <br />
                      ...
                      <asp:GridView runat="server" ID ="gd_choferes"  BackColor="White" BorderColor="#D3D59F" BorderStyle="Groove" CssClass="auto-style3" EnableTheming="True" Font-Names="MS Reference Sans Serif" Font-Size="Medium" Font-Strikeout="False" ForeColor="Black" Height="249px" HorizontalAlign="Center" Width="827px"> 
